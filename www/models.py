...
class Talk(BasisModell):
    ...
    blacklisted = models.BooleanField(default=False, blank = True)
    day = models.ForeignKey(Event_Days, default = 1, blank = True, on_delete=models.CASCADE)
    room = models.ForeignKey(Rooms, default = 15, on_delete=models.CASCADE)
    ...
    track = models.ForeignKey(Tracks, default = 40, blank = True, on_delete=models.CASCADE)
    event = models.ForeignKey(Event, default = 3, blank = True, on_delete=models.CASCADE)
    type_of = models.ForeignKey(Type_of, default = 9, blank = True, on_delete=models.CASCADE)
    orig_language = models.ForeignKey(Language, default = 287, blank = True, on_delete=models.CASCADE)
...
class Subtitle(BasisModell):
    ...
    language = models.ForeignKey(Language, on_delete=models.CASCADE)#, to_field = "lang_amara_short")
    ...
    state = models.ForeignKey(States, default = 1, blank = True, on_delete=models.CASCADE)
